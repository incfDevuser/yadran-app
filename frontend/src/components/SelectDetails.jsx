      ...
      <div className="w-full">
        <div className="lg:w-[872px] w-full flex flex-col gap-10">
          ...
          <div className="flex flex-wrap items-center  justify-start gap-3 mt-48 lg:mt-1 ">
            ...
            >
              <option value="Fechas" className="">
                Cuando
              </option>
              <option value="Esta semana">$100-300</option>
              <option value="Este mes">$300-600</option>
              <option value="En curso">$600-1000</option>
            </select>
            <select
              name="shops"
              id="shops"
            ...
            >
              ...
              <option value="Sky">Japan</option>
              <option value="Taxis donde pepe">Hawai</option>
              <option value="Bote Jenny 1">Dubai</option>
            </select>
            <select
              name="class"
              id="class"
            ...
            >
              ...
              <option value="Habitual">A</option>
              <option value="Visita">B</option>
              <option value="Emergencia">C</option>
            </select>
            <select
              name="price"
              id="max-price"
