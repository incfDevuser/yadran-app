              ...
              centros.map((centro) => (
                ...
                >
                  ...
                  <p className="text-gray-700 flex items-center gap-2">
                    <FaMapMarkerAlt className="text-blue-500" /> Ubicación:
                    {` Lat: ${centro.latitud}, Lon: ${centro.longitud}`}
                  </p>
                  <p className="text-gray-700 flex items-center gap-2">
                    <FaCalendarAlt className="text-blue-500" /> Apertura:
                    {new Date(
                  ...
                  <p className="text-gray-700 flex items-center gap-2">
                    <FaUserTie className="text-blue-500" /> Jefe del centro:{" "}
                    {centro.jefe_centro}
                  </p>
                  <p className="text-gray-700 flex items-center gap-2">
                    <FaWarehouse className="text-blue-500" /> Pontón:{" "}
                    {centro.nombre_ponton}
                  </p>
                  <p className="text-gray-700 flex items-center gap-2">
                    <FaWarehouse className="text-blue-500" /> Ruta asociada:{" "}
                    {centro.nombre_ruta}
                  </p>
                  ...
                  <h4 className="mt-4 font-semibold text-gray-800">Clima</h4>
                  {centro.clima ? (
