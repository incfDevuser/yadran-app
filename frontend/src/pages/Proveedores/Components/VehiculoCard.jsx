    ...
    <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition-all duration-300 border border-gray-100">
      <div className="flex justify-between items-start mb-6">
        <div className="flex items-center gap-3">
          <div>
            ...
            <p className="text-blue-600 font-medium text-sm">{tipo_servicio}</p>
          </div>
        </div>
      ...
      <div className="flex flex-col gap-3 font-medium">
        <div className="flex justify-between gap-3">
          <button
            className="flex-1 px-4 py-2.5 bg-white border-2 border-blue-600 text-blue-700 rounded-lg hover:bg-purple-50 transition-all duration-300 flex items-center justify-center gap-2"
          ...
          <button
            className="flex-1 px-4 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all duration-300 flex items-center justify-center gap-2"
