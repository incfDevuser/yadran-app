     ...
     <div className="flex flex-col gap-10 ">
            <div>
              <div className="flex flex-col items-start justify-start">
                <h1 className="text-[#7C8DB0] font-semibold text-lg leading-6">
                  <span className="text-[#6E7491]"> Informacion del Clima</span> (flexible
                  dates)
                </h1>
              </div>
            ...
            <div className="flex flex-col items-start justify-start gap-5">
              ...
              <div className="flex flex-col items-start justify-start max-w-sm gap-2 px-3">
                ...
                Recomendamos reservar pronto. El costo promedio de este vuelo es de $750,
                pero podría aumentar un 18% a $885 en dos semanas.
                </p>
                <p className="text-[#A1B0CC] ">
                Triptrack conexion con cocha!
                </p>
              </div>
            </div>
          </div>
