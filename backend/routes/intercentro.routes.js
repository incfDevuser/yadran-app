...
//Solicitar ruta
router.post("/solicitar", AuthMiddleware.authToken , IntercentroController.solicitarRuta);


//Aprobar o rechazar Solicitud - Admin
router.put("/solicitudes/:solicitud_id/aprobar", IntercentroController.aprobarSolicitud);
router.put("/solicitudes/:solicitudId/cancelar", IntercentroController.cancelarSolicitud);
