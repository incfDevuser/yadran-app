  ...
  try {
    const query = `
      SELECT umi.id AS solicitud_id,
             ...
             COALESCE(u.rut, t.identificacion) AS rut,
             COALESCE(u.numero_contacto, t.telefono) AS contacto,
             COALESCE(u.fecha_nacimiento, t.fecha_nacimiento) AS fecha_nacimiento,
             mi.fecha,
             mi.centro_origen_id,
             co.nombre_centro AS centro_origen_nombre,
